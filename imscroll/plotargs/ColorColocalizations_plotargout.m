function pc=ColorColocalizations_plotargout(dat,cia,AOInum,LowColor,HighColor,offset, fignum, handles)
% function ColorColocalizations_plotargout(dat,cia,AOInum,LowColor,HighColor, offset, fignum, handles)
%  
